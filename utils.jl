...
Download Advent of Code 2023 input data for the given `day`.

A valid `cookie` must be provided, for example by logging into the
[Advent of Code website](https://adventofcode.com/2023) with a browser and copying the
...
function get_aoc_input(day::Integer, cookie::AbstractString)
    ...
    r = HTTP.get("https://adventofcode.com/2023/day/$day/input", cookies=cookies)
    String(r.body)
end
